...
public class Canon {
    ...
    static boolean commute(Tree.Stm a, Tree.Exp1 b) {
        return isNop(a)
    ...
    private static StmExpList reorder(LinkedList<Exp1> kids) {
        // TODO
        return null;
    }
    ...
    static StmExpList reorder(Tree.ExpList exps) {
        if (exps==null) return nopNull;
            ...
            Tree.Exp1 a = exps.head;
            if (a instanceof Tree.CALL) {
                Temp t = new Temp();
                Tree.Exp1 e = new Tree.ESEQ(new Tree.MOVE(new Tree.TEMP(t), a),
                                           new Tree.TEMP(t));
