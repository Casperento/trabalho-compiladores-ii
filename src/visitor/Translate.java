...
public class Translate extends GJDepthFirst<Exp,MJType> {
    ...
    public Level newLevel(Symbol name, boolean isLeaf,
    ...
    public Exp visit(ArrayAssignmentStatement n, MJType argu) {
        ...
        ExpList args1 = new ExpList(null, null);
        Label T = new Label();
        Label F = new Label();
    ...
    public Exp visit(PrintStatement n, MJType argu) {
        ...
        ExpList args1 = new ExpList(e.unEx(), null);
    ...
    public Exp visit(MessageSend n, MJType argu) {
        ...
        ExpList argsList = new ExpList(TEMP(t3), null);
        if (n.f4.present()) {
            argsList = new ExpList(n.f4.accept(this, argu).unEx(), null);
            argsList.head = TEMP(t3);
        }
    ...
    public Exp visit(ExpressionList n, MJType argu) {
        ...
        return new Ex(Tree.ExpList.fromArrayList(args));
    }
    ...
    public Exp visit(ArrayAllocationExpression n, MJType argu) {
        ...
        ExpList args1 = new ExpList(size, null);
    ...
    public Exp visit(AllocationExpression n, MJType argu) {
        ...
        ExpList args1 = new ExpList(CONST(sz_m),  null);
        ExpList args2 = new ExpList(CONST(sz_f), null);
